...
if __name__ == '__main__':
    ...
    gt_path = '/mnt/wd1/cv_dep/2017/DAIC-WOZ-Unzip/full_test_split -v1.csv'
    ...
    for i in range(len(gt_df)):
        ...
        if patient_ID == 300:
            hog_path = f'/mnt/wd1/cv_dep/2017/wpingcheng/{patient_ID}_CLNF_hog.bin'
            continue
        else:
        ...
        num_frame = sliding_window(filtered_fkps_features, filtered_gaze_features, filtered_AUs_features, 
                                   filtered_pose_features, filtered_hog_features,
        ...
        num_frame = sliding_window(clipped_fkps_features, clipped_gaze_features, clipped_AUs_features, 
                                   clipped_pose_features, clipped_hog_features, visual_sr, window_size, overlap_size, output_root, patient_ID)
