...
# validation是从train复制过来的，因为代码中val和train的测评一致，test是缺一部分，test.py的
    # output root
    root = '/mnt/wd1/cv_dep/2017/wpingcheng'
    root_dir = os.path.join(root, 'DAIC_WOZ-generated_database_V2', 'validation')
    create_folders(root_dir)
    np.random.seed(1)

    # read training gt file
    gt_path = '/mnt/wd1/cv_dep/2017/DAIC-WOZ-Unzip/dev_split_Depression_AVEC2017.csv'
